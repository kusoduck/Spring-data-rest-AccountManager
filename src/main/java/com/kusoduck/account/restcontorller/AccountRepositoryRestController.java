...
public class AccountRepositoryRestController {
		private IAccountService accountService;

		@Autowired
		public AccountRepositoryRestController(@Qualifier("accountRepositoryService") IAccountService theAccountService) {
